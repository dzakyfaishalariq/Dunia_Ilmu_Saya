<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link @if ($title == 'Home (Admin)') active @endif" href="/home_Admin">
                    <div
            ...
            <li class="nav-item">
                <a class="nav-link  @if ($title == 'Buat_soal (Admin)') active @endif" href="/buat_soal">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Buat Soal</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  @if ($title == 'Kategori Bidang (Admin)') active @endif" href="/buat_kategori_bidang">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <span class="material-symbols-outlined">
                            edit_square
                    ...
                    <span class="nav-link-text ms-1">Kategori Bidang</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link  " href="/logout_system">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
